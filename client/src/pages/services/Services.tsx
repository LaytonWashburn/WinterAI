...
export const Services = () => {
    ...
    const services = [
        {id:0, name: "Duck Duck Go Search", description: "Search the web using Duck Duck Go.", link:"/search"},
        {id: 1, name: 'Personalized Agent', description: 'Helps streamline your tasks and boost productivity.', link:"/"},
